      ...
      {activeTab === 'docs' ? (
        ...
        <div className="max-w-7xl mx-auto px-4 pb-16 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <section className="glass-card p-6 flex flex-col gap-6 relative overflow-hidden">
            <div className="flex justify-between items-center border-b border-gray-700/50 pb-4">
              <h2 className="text-xl font-semibold text-white">Prediction Engine</h2>
              <div className="flex items-center gap-2">
                <span className={`w-2 h-2 rounded-full ${results ? 'bg-emerald-500 animate-pulse' : 'bg-gray-500'}`}></span>
                <span className="text-xs text-gray-400 uppercase tracking-widest">{results ? 'Complete' : 'Ready'}</span>
              </div>
            </div>

            {!results ? (
              <div className="flex-1 flex items-center justify-center text-center px-6">
                <p className="text-gray-400 border border-gray-700/50 bg-gray-800/30 px-6 py-4 rounded-xl text-sm">
                  Enter biological metrics and attach ocular scans to initiate real-time predictive analysis.
                </p>
              </div>
            ) : (
              <div className="flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="flex items-end gap-2">
                      <span className={`text-4xl font-extrabold pb-0 leading-none ${
                ...
                {/* Tier Card */}
                <div className={`p-4 rounded-xl border border-l-4 shadow-lg ${
